    ...
    <>
            ...
            {passos.map((p, idx) => (
              <ScrollReveal key={p.num} delay={idx * 80}>
                <div className="border-l-2 border-gt-orange pl-5">
                  <div className="text-gt-orange-text font-medium text-sm mb-2 font-sans">{p.num.toString().padStart(2, '0')}</div>
        ...
        <div className="container-wide">
          <ScrollReveal>
            <div className="max-w-3xl mx-auto bg-gt-bg border border-gt-border rounded-lg p-8 md:p-12 text-center mb-10">
              <p className="text-xs uppercase tracking-[0.18em] text-gt-orange-text mb-3 font-sans">{t('precos.labelLancamento')}</p>
              ...
              <p className="text-sm text-gt-text-muted font-sans leading-relaxed mb-6 max-w-xl mx-auto">
                ...
                <a href="/termos/conta-business" className="text-gt-orange-text hover:underline">Ver política completa</a>.
              </p>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <ScrollReveal delay={0}>
                <div className="bg-gt-bg rounded-lg p-6 border border-gt-border">
                  <p className="text-xs uppercase tracking-wider text-gt-orange-text mb-3 font-sans font-medium">Produtos no Desapega</p>
              ...
              <ScrollReveal delay={80}>
                <div className="bg-gt-bg rounded-lg p-6 border border-gt-border">
                  <p className="text-xs uppercase tracking-wider text-gt-orange-text mb-3 font-sans font-medium">Pontos destacados (Waypoints)</p>
                  <p className="text-sm text-gt-text-muted leading-relaxed font-sans mb-4">
              ...
              <ScrollReveal delay={160}>
                <div className="bg-gt-bg rounded-lg p-6 border border-gt-border">
                  <p className="text-xs uppercase tracking-wider text-gt-orange-text mb-3 font-sans font-medium">Expedições e perfis (Serviços)</p>
                  <p className="text-sm text-gt-text-muted leading-relaxed font-sans mb-4">
            ...
            <p className="text-xs text-gt-text-dim mt-8 font-sans leading-relaxed text-center">
              Pra agências de turismo com muitos guias ou modelos customizados, fale com a gente em <a href="mailto:business@gtoverlander.com.br" className="text-gt-orange-text hover:underline">business@gtoverlander.com.br</a>.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="cadastro" className="bg-gt-card py-16 md:py-24 border-t border-gt-border scroll-mt-20">
        <div className="container-narrow">
          <ScrollReveal>
            <p className="text-xs uppercase tracking-[0.18em] text-gt-orange-text mb-3 font-sans">{t('cadastro.label')}</p>
