...
/**
 * Páginas 2, 3, 4... de /blog/vida-overlander. A página 1 fica no caminho base;
...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: getPageAlternates(locale, `/blog/vida-overlander/pagina/${n}`),
  };
}

export const revalidate = 60;

export default function VidaOverlanderPaginaPage({
  params: { locale, page },
}: {
  params: { locale: string; page: string };
}) {
  ...
  return <PillarPage pillar="vida-overlander" locale={blogLocale} page={n} />;
}
