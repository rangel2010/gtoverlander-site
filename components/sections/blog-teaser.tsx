        ...
        <div className="mt-10 pt-8 border-t border-gt-border flex flex-col sm:flex-row sm:items-center gap-4">
          <div className="flex flex-col gap-1 sm:w-44 flex-shrink-0">
            <div className="flex items-center gap-1.5">
              <svg width="13" height="13" viewBox="0 0 24 24" fill="currentColor" className="text-gt-orange flex-shrink-0" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
              ...
              <p className="text-xs text-gt-text-muted font-sans leading-tight">
                {t('podcastPrefere')}
              </p>
            </div>
            <p className="text-xs uppercase tracking-wider text-gt-text-muted font-sans font-medium leading-tight pl-4">
              {t('podcastTexto')}
              <br />
              {t('podcastNome')}
            </p>
