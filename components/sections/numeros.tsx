        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-6">
          {stats.map((s, i) => (
            <ScrollReveal key={i} delay={i * 100}>
              <div className="text-4xl md:text-5xl font-display uppercase tracking-display text-gt-text mb-2">{s.valor}</div>
              <p className="text-sm text-gt-text-muted leading-snug max-w-[180px] font-sans">{s.contexto}</p>
            </ScrollReveal>
          ))}
        </div>
